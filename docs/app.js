...
</script></body></html>`;const w=open("","_blank");if(!w){const reportUrl=URL.createObjectURL(new Blob([reportHtml],{type:"text/html;charset=utf-8"}));location.href=reportUrl;return}w.document.write(reportHtml);w.document.close();w.focus()}
